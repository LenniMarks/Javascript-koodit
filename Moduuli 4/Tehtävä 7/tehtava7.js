...
const haku = 'https://api.digitransit.fi//routing/v1/routers/hsl/index/graphql';
...
const haku2 = 'http://api.digitransit.fi/geocoding/v1/search?text=' + address;
const url2 = proxy + encodeURIComponent(haku2);

addressform.addEventListener('submit', async function(evt) {
    evt.preventDefault();
